...
__1. List length__ - Write a function that returns the number of elements in a linked listint_t list.  
...
__12. Print (safe version)__ - Write a function that prints a listint_t linked list.  
